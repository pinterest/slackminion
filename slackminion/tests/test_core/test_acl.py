...
class TestAuthManager(unittest.TestCase):
    ...
    def setUp(self, *args):
        ...
        self.test_user = SlackUser(
            user_info=test_user_response["user"], api_client=self.object._bot.api_client
        )
    ...
    def test_acl_invalid_action(self):
        e = self.test_event
        assert (
            self.object.acl(e, ["not_a_command"])
            == "Valid actions: allow, deny, remove, show, new, delete"
        )
    ...
    def test_acl_allow_nonexist_acl(self):
        ...
        assert (
            self.object.acl_allow(e, ["test", "testuser"])
            == "Failed to add testuser to test (allow)"
        )
    ...
    def test_acl_deny(self):
        ...
        self.object.acl_new(e, ["test"])
        assert (
            self.object.acl_deny(e, ["test", "testuser"])
            == "Added testuser to test (deny)"
        )
    ...
    def test_acl_deny_nonexist_acl(self):
        ...
        assert (
            self.object.acl_deny(e, ["test", "testuser"])
            == "Failed to add testuser to test (deny)"
        )
    ...
    def test_acl_remove(self):
        ...
        self.object.acl_allow(e, ["test", "testuser"])
        assert (
            self.object.acl_remove(e, ["test", "testuser"])
            == "Removed testuser from test (allow and deny)"
        )
    ...
    def test_acl_remove_nonexist_acl(self):
        ...
        assert (
            self.object.acl_remove(e, ["test", "testuser"])
            == "Failed to remove testuser from test (allow and deny)"
        )
    ...
    def test_acl_show_acl(self):
        ...
        self.object.acl_new(e, ["test"])
        self.object.acl_allow(e, ["test", "testuser"])
        self.object.acl_show(
            e, ["test"]
        ) == "testuser: ACL 'test' is defined as follows:\nallow: testuser\ndeny: "
    ...
    def test_admin_check_admin_cmd_non_user(self):
        self.object._bot.dispatcher.register_plugin(DummyPlugin(self.object._bot))
        test_user = SlackUser(
            user_info=test_payload["data"], api_client=self.object._bot.api_client
        )
